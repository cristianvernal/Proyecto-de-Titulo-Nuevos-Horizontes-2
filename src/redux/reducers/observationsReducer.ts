...
export const observationReducer = (
  ...
  switch (action.type) {
    case types.OBSERVATIONS_GET_SUBMITING:
      return {
        ...state,
        state: FormState.Submitting,
        error: undefined,
      };
    case types.OBSERVATIONS_GET_SUCCESS:
      return {
        ...state,
        state: FormState.Success,
        observations: action.payload.users,
        totalDocs: action.payload.totalDocs,
        lastDoc: action.payload.lastDoc,
      };
    case types.OBSERVATIONS_GET_FAILURE:
      return {
        ...state,
        state: FormState.Failure,
        error: action.payload,
      };
    case types.OBSERVATIONS_ADD_INITIAL:
      return {
        ...state,
        add: {
          state: FormState.Initial,
    ...
    case types.OBSERVATIONS_ADD_SUBMITING:
      return {
        ...state,
        add: {
          state: FormState.Submitting,
    ...
    case types.OBSERVATIONS_ADD_SUCCESS:
      return {
        ...state,
        add: {
          state: FormState.Success,
    ...
    case types.OBSERVATIONS_ADD_FAILURE:
      return {
        ...state,
        add: {
          state: FormState.Failure,
