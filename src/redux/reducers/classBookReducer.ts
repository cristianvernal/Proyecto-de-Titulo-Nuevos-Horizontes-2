...
export const classBookReducer = (
  state = initialState,
  action: Action
): ClassBookState => {
  switch (action.type) {
    case types.CLASSBOOKS_GET_SUBMITING:
      return {
        ...state,
        state: FormState.Submitting,
        error: undefined,
      };
    case types.CLASSBOOKS_GET_SUCCESS:
      return {
        ...state,
        state: FormState.Success,
        classBooks: action.payload.users,
        totalDocs: action.payload.totalDocs,
        lastDoc: action.payload.lastDoc,
      };
    case types.CLASSBOOKS_GET_FAILURE:
      return {
        ...state,
        state: FormState.Failure,
        error: action.payload,
      };
    case types.CLASSBOOKS_ADD_INITIAL:
      return {
        ...state,
        add: {
          state: FormState.Initial,
    ...
    case types.CLASSBOOKS_ADD_SUBMITING:
      return {
        ...state,
        add: {
          state: FormState.Submitting,
    ...
    case types.CLASSBOOKS_ADD_SUCCESS:
      return {
        ...state,
        add: {
          state: FormState.Success,
    ...
    case types.CLASSBOOKS_ADD_FAILURE:
      return {
        ...state,
        add: {
          state: FormState.Failure,
