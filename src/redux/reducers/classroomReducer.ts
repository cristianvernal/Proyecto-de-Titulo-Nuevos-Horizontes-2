...
export const classroomReducer = (
  ...
  switch (action.type) {
    case types.CLASSROOMS_GET_SUBMITING:
      return {
        ...state,
        state: FormState.Submitting,
        error: undefined,
      };
    case types.CLASSROOMS_GET_SUCCESS:
      return {
        ...state,
        state: FormState.Success,
        classrooms: action.payload.users,
        totalDocs: action.payload.totalDocs,
        lastDoc: action.payload.lastDoc,
      };
    case types.CLASSROOMS_GET_FAILURE:
      return {
        ...state,
        state: FormState.Failure,
        error: action.payload,
      };
    case types.CLASSROOMS_ADD_INITIAL:
      return {
        ...state,
        add: {
          state: FormState.Initial,
    ...
    case types.CLASSROOMS_ADD_SUBMITING:
      return {
        ...state,
        add: {
          state: FormState.Submitting,
    ...
    case types.CLASSROOMS_ADD_SUCCESS:
      return {
        ...state,
        add: {
          state: FormState.Success,
    ...
    case types.CLASSROOMS_ADD_FAILURE:
      return {
        ...state,
        add: {
          state: FormState.Failure,
