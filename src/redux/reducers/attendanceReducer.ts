...
export const attendanceReducer = (
  ...
  switch (action.type) {
    case types.ATTENDANCES_GET_SUBMITING:
      return {
        ...state,
        state: FormState.Submitting,
        error: undefined,
      };
    case types.ATTENDANCES_GET_SUCCESS:
      return {
        ...state,
        state: FormState.Success,
        attendance: action.payload.users,
        totalDocs: action.payload.totalDocs,
        lastDoc: action.payload.lastDoc,
      };
    case types.ATTENDANCES_GET_FAILURE:
      return {
        ...state,
        state: FormState.Failure,
        error: action.payload,
      };
    case types.ATTENDANCES_ADD_INITIAL:
      return {
        ...state,
        add: {
          state: FormState.Initial,
    ...
    case types.ATTENDANCES_ADD_SUBMITING:
      return {
        ...state,
        add: {
          state: FormState.Submitting,
    ...
    case types.ATTENDANCES_ADD_SUCCESS:
      return {
        ...state,
        add: {
          state: FormState.Success,
    ...
    case types.ATTENDANCES_ADD_FAILURE:
      return {
        ...state,
        add: {
          state: FormState.Failure,
