...
const colorsBioAdm = {
  primary: "#009fda", // Color Sidebar Center
  secondary: "#005B96",
};
// colores Actuales DemandaApp
...
const blueVariant = merge(defaultVariant, {
  ...
  sidebar: {
    color: "#FFF",
    background: colorsBioAdm.primary,
    header: {
      color: "#FFF",
      background: "#13309C", // Background Sidebar Top Logo
      brand: {
        color: "#FFFFFF",
      },
    },
    footer: {
      color: "#FFF",
      background: "#007ac9", // Background Sidebar Username
      online: {
        background: "#FFF",
      },
    },
